...
inputs, outputs, gate_io = netlist_graph.extract_gate_io(r"C:\Users\akhil\OneDrive\Documents\SEMESTER_2\VDA\Assignments\ISCAS85\s27.bench")
...
starting_node = input("Enter the starting node: ").upper()
...
# graph_search_algo.depth_first_search(adjacency_matrix, starting_node, node_list, nodes_dict, visited_list, stack_nodes, path_of_dfs)
# graph_search_algo.breadth_first_search(adjacency_matrix, starting_node, nodes_dict, node_list)

# target_node = input("Enter the tagret node for shortest path: ")
shortest_path.dijkstra(adjacency_matrix, node_list, starting_node)
# shortest_path.dijkstra(adjacency_matrix, node_list, starting_node, target_node)